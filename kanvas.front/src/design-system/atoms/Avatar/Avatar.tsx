...
const StyledAvatar = styled(MAvatar)<AvatarProps>`
  ...
  @media (max-width: 1100px) {
    height: ${(props) =>
      props.responsive ? (props.height ?? 40) * 0.7 : props.height ?? 40}px;
    width: ${(props) =>
  ...
  @media (max-width: 650px) {
    height: ${(props) =>
      props.responsive ? (props.height ?? 40) * 0.6 : props.height ?? 40}px;
    width: ${(props) =>
  ...
  @media (max-width: 400px) {
    height: ${(props) =>
      props.responsive ? (props.height ?? 40) * 0.55 : props.height ?? 40}px;
    width: ${(props) =>
      props.responsive ? (props.width ?? 40) * 0.55 : props.width ?? 40}px;
  }
`
