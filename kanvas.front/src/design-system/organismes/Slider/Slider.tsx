...
import { Box, CardMedia, Skeleton, useMediaQuery, useTheme,  Paper, Card } from '@mui/material';
        ...
        <>
            {
                nftResponse.loading ?
                    ...
                    :
                    <Box sx={{ display: isMobile ? 'none' : 'block', borderRadius: 0, marginLeft: 'auto', width: '80%' }} >
                        <Carousel
                            swipe={true}
                            cycleNavigation
                            interval={4000}
                        ...
                        >
                            {mockCarousel.map((node, index) => (
                                <Card sx={{ display: 'flex', borderRadius: '0'}} key={index}>
                                    <StyledBox animationInDelay={1200} animationIn="fadeIn" animationOut="fadeOut" isVisible={true}>
                                        <Typography
                                            size="h2"
                                            weight="SemiBold"
                                            color="#fff"
                                        ...
                                        <CustomButton size="medium" href={node.url} label={t('home.hero.button_3')} />
