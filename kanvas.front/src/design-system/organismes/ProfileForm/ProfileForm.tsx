    ...
    return (
        ...
        >
            <StyledForm onSubmit={formik.handleSubmit} >
                    ...
                    <Element name='userName'>
                        <StyledInput
                            ...
                            InputProps={{
                                ...
                                endAdornment: <InputAdornment position="start"> { false  ? <CustomCircularProgress height={1} /> : null  } </InputAdornment>
                            }}
                ...
                <CustomButton size="medium" onClick={() => formik.handleSubmit()} label={'Save'} sx={{width: '10rem'}} loading={props.loading}/>
