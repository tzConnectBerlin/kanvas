...
export const EditProfile : FC<EditProfileProps> = () => {
    ...
    const [initialValues, setInitialValues] = useState<{userName: string, profilePicture: string}>({
        userName: '',
        profilePicture: ''
    })
        ...
        <PageWrapper>
            <StyledStack direction="column" spacing={3}>
                ...
                <Animated animationIn="fadeIn" animationOut="fadeOut" isVisible={true}>
                    <Typography size="h1" weight='SemiBold' sx={{paddingLeft: '2rem', paddingRight: '2rem', justifyContent: 'center'}}>Edit your profile</Typography>
                </Animated>

                <FlexSpacer minHeight={2} />

                <ProfileForm initialValues={initialValues} submit={() => {}} loading={false}/>
