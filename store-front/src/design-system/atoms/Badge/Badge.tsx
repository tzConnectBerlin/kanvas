...
const StyledBadge = styled(Badge)<IBadge>`
  .MuiBadge-badge {
    transform: ${(props) =>
      props.profile
        ? 'scale(1) translate(25%,-30%)'
        : props.badgeContent && props.badgeContent < 10
        ? 'scale(1) translate(-65%,-35%)'
        : 'scale(1) translate(-20%,-45%)'};
    background-color: ${(props) =>
      props.color === 'error' ? '#FB3E3E' : props.theme.palette.primary.dark};
