...
export const MINTER_PUBLIC_KEY = assertEnv('MINTER_PUBLIC_KEY'); // this is the revealed public key associated to the MINTER_ADDRESS (MINTER_ADDRESS is the public key hash)
